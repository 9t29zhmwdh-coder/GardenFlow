# Copilot Instructions for GardenFlow
GardenFlow is a modular home garden automation toolkit that connects sensors (ESP32, Zigbee, MQTT), runs rule-based automation, and visualizes everything in a real-time web dashboard.
## Code style
